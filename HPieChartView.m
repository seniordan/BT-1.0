...
- (void) initWheel {
    ...
    BNPieChart* chart = [[BNPieChart alloc] initWithFrame:CGRectMake(0, 0, 150, 150)];
...
//    UIImageView *imgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 235, 235)];
//    imgView.image = [UIImage imageNamed:@"icon_round_calibration"];
//    imgView.center = CGPointMake(150, 150);
//    [chart addSubview:imgView];
//
//    UIImageView *img = [[UIImageView alloc] initWithFrame:CGRectMake(10, 12, 180, 180)];
////    img.center = CGPointMake(151, 151);
//    img.image = [UIImage imageNamed:@"icon_round_needle"];
//    img.userInteractionEnabled = NO;
//    [self addSubview:img];
    
//    self.label1 = [[UILabel alloc] initWithFrame:CGRectMake(63, 30, 60, 40)];
//    self.label1.text = @"0.0";
//    self.label1.font = [UIFont systemFontOfSize:40];
//    self.label1.textColor = [UIColor blackColor];
//    [chart addSubview:self.label1];
//    
//    self.label2 = [[UILabel alloc] initWithFrame:CGRectMake(self.label1.frame.origin.x + 18, self.label1.frame.origin.y + self.label1.frame.size.height + 5, 30, 25)];
//    self.label2.font = [UIFont systemFontOfSize:20];
//    self.label2.textColor = [[UIColor alloc] initWithRed:120 % 256 / 255.0 green:120 % 256 / 255.0 blue:120 % 256 / 255.0 alpha:1];
//    self.label2.text = @"kg";
//    [chart addSubview:self.label2];
//    
//    self.label3 = [[UILabel alloc] initWithFrame:CGRectMake(self.label2.frame.origin.x - 20, self.label2.frame.origin.y + self.label2.frame.size.height + 15, 80, 25)];
//    self.label3.text = @"BMI:0.0";
//    self.label3.textColor = [UIColor blackColor];
//    self.label3.font = [UIFont systemFontOfSize:20];
//    [chart addSubview:self.label3];
